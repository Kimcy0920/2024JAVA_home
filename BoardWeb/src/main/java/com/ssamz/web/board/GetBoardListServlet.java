...
//		}
		...
		String condition = (String)session.getAttribute("condition"); // 세션에서 컨디션 정보 가져오기
		if(condition.equals("TITLE")) {
			out.println("<option value='TITLE' selected>제목"); // 옵션: 제목
		} else {
			out.println("<option value='TITLE'>제목");
		}
		if(condition.equals("CONTENT")) {
			out.println("<option value='CONTENT' selected>내용"); // 옵션: 내용
		} else {
